...
//2.Taking string number as an argument
/*
  console.log(arr.splice("1"));// [3,2,4,5,6]
  console.log(arr);//[1]
 */

//3. Taking no arguments
/*
...
// 13.Taking boolean as parameter
/*
...
//16. Taking boolean parameter in splice(p1,p2,p3)
/*
