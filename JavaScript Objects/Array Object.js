...
//1.We are checking if it display all the element in the parenthesis or not
/*
var arr=(1,3,5,4);
console.log(arr); //4
 */

//2.We can also re-assign the value in the array.
/*
var arr=[1,3,5,7,9];
arr[1]=6;
...
//3.Checking if array is growable or not and as well as we can add element at any position
/*
var arr=[12,13,34,56];
arr[5]=76;
...
//4.pop()- it is used to delete element at the end of the array.
/*
var arr=[1,3,2,4];
...
//5.push()- this method adds the element at the end or the array.
/*
var arr=[1,3,2,4];
console.log(arr);//[1,3,2,4]
...
//6.shift()-this method is used for deleting the 1st value from the array.
/*
var arr=[1,3,2,4];
console.log(arr);//[1,3,2,4]
...
//7.unshift()-this is the method by which it adds the value at the starting of the array.
/*
var arr=[1,3,2,4];
console.log(arr);//[1,3,2,4]
...
//8.splice()- splice() with one argument act as deleting all the elements from that index.
/*
var arr=[1,3,2,4,5,6];
...
//9.splice(p1,p2)- splice with two parameter where it starts from the p1-index and p2- no. of elements to be deleted.
/*
var arr=[1,3,2,4,5,6];
console.log(arr);//[1,3,2,4,5,6]
...
//10.splice(p1,p2,p3)- splice with three argument acts as p1- index,p2-no. of element to be deleted,p3- element
// to be added
/*
var arr=[1,3,2,4,5,6];
console.log(arr);//[1,3,2,4,5,6]
...
//11.sort()- so this function sorts the array in ascending order and it sorts by unit wise or we can say that
//unicode.
/*
...
//12.filter() is a function which is used to filter the values in the array, so it accepts minimum one parameter.
...
//13. reduce() reduce is the function which is use to reduce the whole array in to a single value.
...
//14.Map() function performs action on each & every element in array.
